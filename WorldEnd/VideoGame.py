...
pygame.display.set_caption("World End")
...
while j > 0:
    win.blit(bg, (0, 0))
    start_font = pygame.font.SysFont('comicsans', 100)
    start_txt = start_font.render('Starting ' + str(j) , 1, (255, 0, 0))
    win.blit(start_txt, (250 - (start_txt.get_width() / 2), 200))
...
class player(object):
    ...
    def hit(self, life):
        ...
        # pygame.display.update()
        if life == 0:
            life_txt = font.render('Lives: ' + str(life), 1, (0, 0, 255))
            win.blit(life_txt, (10, 10))
    ...
    def hit(self):
        ...
        if self.health > 0:
            ...
            if self.count == 0:
                ...
                text = font1.render('Congratulations!!!', 1, (0, 255, 0))
                win.blit(text, (250 - (text.get_width() / 2), 200))
...
def redrawGameWindow():
    ...
    win.blit(score_txt, (350, 10))

    life_txt = font.render('Lives: ' + str(life), 1, (0, 0, 255))
    win.blit(life_txt, (10, 10))

    zombie_txt = font.render('Zombies: ' + str(zombie.count), 1, (255, 0, 255))
    win.blit(zombie_txt, (10, 30))
...
zombie1 = enemy(100, 410, 64, 64, 450)
zombie2 = enemy(300, 410, 64, 64, 450)
